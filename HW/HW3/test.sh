...
#SBATCH --mem=4G	# amount of memory for the job
#SBATCH -G a100:1	# number of gpus
#SBATCH -c 1		# number of cores
#SBATCH -t 0-10:00:00	# time in d-hh:mm:ss
#SBATCH -p general	# partition
#SBATCH -q public	# QOS
#SBATCH -o imagenet.%j.out	# file to save job's STDOUT (%j = JobId)
#SBATCH -e imagenet.%j.err	# file to save job's STDERR (%j = JobId)
