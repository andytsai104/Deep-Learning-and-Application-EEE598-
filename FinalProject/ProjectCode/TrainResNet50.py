...
for epoch in range(num_epochs):
    ...
    if test_accuracy > best_accuracy:
        ...
        save_path = r"/home/ctsai67/EEE598/FinalProject/ProjectCode/TrainedModels/ResNet50.pth"
        torch.save({
...
# Plot Training Loss
loss_path = r'/home/ctsai67/EEE598/FinalProject/ProjectCode/loss_img/ResNet50.png'
...
plt.figure(figsize=(10, 5))
testimg_path = r'/home/ctsai67/EEE598/FinalProject/ProjectCode/test_acc_img/ResNet50.png'
x_label = list(range(1, len(test_acc_list)+1))
plt.title("Testing Accuracy for ResNet50")
