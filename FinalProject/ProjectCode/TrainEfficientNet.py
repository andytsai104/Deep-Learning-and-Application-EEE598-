...
for epoch in range(num_epochs):
    ...
    if test_accuracy > best_accuracy:
        ...
        save_path = r"/home/ctsai67/EEE598/FinalProject/ProjectCode/TrainedModels/EfficientNet.pth"
...
loss_path = r'/home/ctsai67/EEE598/FinalProject/ProjectCode/loss_img/EfficientNet.png'
plt.figure(figsize=(10, 5))
x_label = list(range(len(training_loss)))
plt.title("Training Loss for EfficientNet-B0")
...
plt.figure(figsize=(10, 5))
testimg_path = r'/home/ctsai67/EEE598/FinalProject/ProjectCode/test_acc_img/EfficientNet.png'
x_label = list(range(1, len(test_acc_list)+1))
plt.title("Testing Accuracy for EfficientNet-B0")
